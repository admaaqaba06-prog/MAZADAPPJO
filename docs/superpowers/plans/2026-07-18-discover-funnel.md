...
3. **DesktopFrame right rail:** `:546` «تنبيهات ومعاملات الضمان» / "ESCROW LEDGER & ALERTS" → «الطلبات والتنبيهات» / "ORDERS & ALERTS"; `:585` escrow-protection footer → AR «مدفوعاتك عبر كليك إلى حساب مزاد جو في كابيتال بنك.» / EN "Payments via CliQ to Mazad JO's Capital Bank account."
