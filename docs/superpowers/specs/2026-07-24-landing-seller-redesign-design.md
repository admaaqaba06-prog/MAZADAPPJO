...
Mazzado is an early two-sided marketplace in Jordan. The binding constraint is **supply (seller inventory)**, not buyers — if a first-time seller doesn't trust Mazzado enough to list a valuable item, the marketplace fails regardless of buyer traffic. The north star (MJ's words): **optimize for seller TRUST, not seller acquisition.**
