        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          {showNameField && (
            <label className="flex flex-col gap-1.5">
              ...
              <input
                ...
                autoComplete="name"
                className="w-full border border-gray-200 rounded-xl px-3.5 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#FF6B00]/40 focus:border-[#FF6B00] bg-gray-50"
          ...
          <label className="flex flex-col gap-1.5">
            ...
            <select
              ...
              className="w-full border border-gray-200 rounded-xl px-3.5 py-3 text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#FF6B00]/40 focus:border-[#FF6B00] bg-gray-50 appearance-none cursor-pointer"
          ...
          {needsEmail && (
            <label className="flex flex-col gap-1.5">
              <span className="text-[11px] font-bold text-gray-500 uppercase tracking-wider flex items-center gap-1.5">
                ...
                {t.profileEmailLabel}
                <span className="normal-case font-medium text-gray-400 tracking-normal">
                  ({t.profileEmailHint})
                </span>
              </span>
              <input
