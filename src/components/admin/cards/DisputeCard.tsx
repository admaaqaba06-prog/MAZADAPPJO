        ...
        <div className="grid grid-cols-3 gap-1.5">
          {options.map(o => (
            <button
              ...
              className={`text-[10px] font-extrabold py-2 rounded-xl border transition-all ${picked === o.value ? 'border-[#FF6B00] bg-accent-weak text-fg' : 'border-line bg-surface-raised text-fg-muted hover:bg-surface-sunken'}`}
            >
              {isAr ? o.ar : o.en}
            </button>
          ))}
