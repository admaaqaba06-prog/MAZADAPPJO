...
export const translations: Record<"ar" | "en", TranslationType> = {
  ar: {
    ...
    hero: {
      ...
      proof: [
        { value: "بدون تأمين", label: "ما في وديعة للمزايدة" },
        { value: "لحد الاستلام", label: "فلوسك محتجزة عند مزادو" },
        { value: "تمديد تلقائي", label: "إذا زايدت بالثواني الأخيرة" },
      ],
  ...
  en: {
    ...
    hero: {
      ...
      proof: [
        { value: "No deposit", label: "nothing to pay to bid" },
        { value: "Held in escrow", label: "released after you receive" },
