  ...
  ar: {
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: "كيف أدفع؟",
          a: "الاشتراكات تُدفع عبر كليك. أما مدفوعات المزادات فيحتفظ بها مزاد جو ولا تُحوَّل للبائع إلا بعد استلامك للقطعة وتأكيدك. تُضاف عمولة مشترٍ ٥٪ عند الفوز."
        },
        {
        ...
        {
          q: "كم تكلفة البيع؟",
          a: "لا شيء مقدماً. البائع يستلم ٩٥٪ — عمولة ٥٪ فقط عند بيع منتجك. إذا لم يُبَع، لا تدفع شيئاً."
        }
      ]
    },
    footer: {
