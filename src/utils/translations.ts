export const translations = {
  ...
  ar: {
    ...
    // Wallet
    myWallet: "سجل محفظتي المالي",
    portfolioVolume: "إجمالي الأصول المودعة بالضمان",
    availableBid: "رصيد المحفظة المتاح للمزايدة",
    escrowMargin: "مبالغ المزايدات المعلقة (الضمان آمن)",
    cliqDepositForm: "إيداع فوري للأموال (كليك للأردن)",
    transferAmt: "مبلغ الإيداع المراد إضافته (دينار)",
    ...
    submitDeposit: "إرسال وصل كليك للإدارة للاعتماد",
    activeEscrows: "عقود الضمان الفورية النشطة",
    noEscrows: "لا توجد أي مبالغ معلقة في مزايدات حالية ريثما تستلم المبيع.",
    ledgerHistorics: "العمليات المالية المؤرشفة بالسجل",
    noLedger: "لم يتم حفظ سجل تصدير حتى الآن في متصفحك.",
